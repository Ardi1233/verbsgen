...
const QUIZV111 = () => {
  ...
  return (
    <View style={styles.quizV11}>
      ...
      <Text
        style={[styles.oopsBannedIs, styles.nextTypo]}
      >{`                                      OOPS!
Banned is not a form of verb 1/2/3 of asked and have the different meaning from asked. so its absolutely the wrong choice`}</Text>
